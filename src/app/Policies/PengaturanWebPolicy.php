...
class PengaturanWebPolicy
{
    ...
    {
        return $user->can('delete_any_pengaturan::web');
    }

    /**
     * Determine whether the user can permanently delete.
     */
    public function forceDelete(User $user, PengaturanWeb $pengaturanWeb): bool
    {
     ...
     */
    public function restore(User $user, PengaturanWeb $pengaturanWeb): bool
    {
     ...
     */
    public function replicate(User $user, PengaturanWeb $pengaturanWeb): bool
    {
