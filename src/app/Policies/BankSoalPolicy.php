...
class BankSoalPolicy
{
    ...
    {
        return $user->can('view_any_bank::soal');
    }
    ...
    {
        return $user->can('view_bank::soal');
    }
    ...
    {
        return $user->can('create_bank::soal');
    }
    ...
    {
        return $user->can('update_bank::soal');
    }
    ...
    {
        return $user->can('delete_bank::soal');
    }
    ...
    {
        return $user->can('delete_any_bank::soal');
    }
     ...
     */
    public function replicate(User $user, BankSoal $bankSoal): bool
    {
