...
class RegistrasiPolicy
{
    ...
    {
        return $user->can('view_any_registrasi');
    }
    ...
    {
        return $user->can('view_registrasi');
    }
    ...
    {
        return $user->can('create_registrasi');
    }
    ...
    {
        return $user->can('update_registrasi');
    }
    ...
    {
        return $user->can('delete_registrasi');
    }
    ...
    {
        return $user->can('delete_any_registrasi');
    }
     ...
     */
    public function replicate(User $user, Registrasi $registrasi): bool
    {
