...
class TugasPolicy
{
    ...
    {
        return $user->can('view_any_tugas');
    }
    ...
    {
        return $user->can('delete_any_tugas');
    }
     ...
     */
    public function replicate(User $user, Tugas $tugas): bool
    {
