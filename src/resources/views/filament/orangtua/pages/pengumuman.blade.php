<div class="w-full space-y-8 text-left" x-data="{ openDetail: null }">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            <h2 class="text-3xl md:text-5xl font-extrabold text-on-surface mb-2">Informasi & Pengumuman Sekolah</h2>
            <p class="text-lg text-on-surface-variant">Ikuti rilis berita, kalender kegiatan, dan info penting dari manajemen sekolah.</p>
        </div>
    </div>
