<div class="w-full space-y-8 text-left">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            <h2 class="text-3xl md:text-5xl font-extrabold text-on-surface mb-2">Laporan Akademik</h2>
            <p class="text-lg text-on-surface-variant">Laporan perolehan nilai dan indeks prestasi belajar Anda.</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="glass-card rounded-3xl p-8 relative overflow-hidden bg-white border border-slate-200/50">
            ...
            <div class="relative z-10">
                <p class="text-xs font-bold text-outline uppercase tracking-wider mb-1">IPK Semester</p>
        ...
        <div class="glass-card rounded-3xl p-8 relative overflow-hidden bg-white border border-slate-200/50">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-on-surface-variant font-semibold">Berdasarkan akumulasi nilai tugas & ujian</p>
            </div>
            <div class="absolute -right-4 -bottom-4 opacity-10">
        ...
        <div class="glass-card rounded-3xl p-8 relative overflow-hidden bg-white border border-slate-200/50">
            ...
            <div class="relative z-10">
                ...
                <p class="text-xs text-on-surface-variant font-semibold">Dari total 38 siswa aktif</p>
            </div>
            <div class="absolute -right-4 -bottom-4 opacity-10">
        ...
        <div class="glass-card rounded-3xl p-6 bg-primary/5 flex flex-col items-center justify-center text-center border-2 border-dashed border-primary/20">
            ...
            <p class="text-[10px] text-outline px-4 mt-1">Diberikan atas konsistensi belajar yang tinggi</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            @forelse($nilais as $n)
                ...
                <div class="glass-card rounded-3xl p-6 border-t-4 border-primary bg-white border border-slate-200/50">
                    ...
                    <p class="text-xs text-outline mb-4">Guru Pengampu: {{ $n->guru?->nama ?? 'Pengampu Mapel' }}</p>
            ...
            @empty
                <div class="col-span-full py-12 flex flex-col items-center justify-center text-center">
                    ...
                    <h3 class="font-extrabold text-xl mb-1 text-slate-800">Belum Ada Nilai</h3>
                    <p class="text-sm text-slate-500">Guru belum mempublikasikan nilai ujian maupun tugas.</p>
                </div>
            @endforelse
        </div>
    </div>
